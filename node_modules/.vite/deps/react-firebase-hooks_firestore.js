...
import {
  ...
  queryEqual,
  refEqual
} from "./chunk-X2SYJ566.js";
import "./chunk-SW746T73.js";
import {
  __toESM
...
var useIsMounted = function() {
  var _a = (0, import_react.useState)(true), isMounted = _a[0], setIsMounted = _a[1];
  (0, import_react.useEffect)(function() {
    return function() {
      setIsMounted(false);
    };
...
var useCollectionOnce = function(query, options) {
  ...
  var ref = useIsFirestoreQueryEqual(query, reset);
  var loadData = (0, import_react.useCallback)(function(query2, options2) {
      ...
      return __generator(this, function(_a2) {
        switch (_a2.label) {
          case 0:
            ...
            get = getDocsFnFromGetOptions(options2 === null || options2 === void 0 ? void 0 : options2.getOptions);
            _a2.label = 1;
          case 1:
            _a2.trys.push([1, 3, , 4]);
            return [4, get(query2)];
  ...
  var reloadData = (0, import_react.useCallback)(function() {
...
var useDocumentOnce = function(docRef, options) {
  ...
  var isMounted = useIsMounted();
  var ref = useIsFirestoreRefEqual(docRef, reset);
  var loadData = (0, import_react.useCallback)(function(reference, options2) {
    return __awaiter(void 0, void 0, void 0, function() {
      var get, result, error_1;
      return __generator(this, function(_a2) {
        switch (_a2.label) {
          case 0:
            ...
            get = getDocFnFromGetOptions(options2 === null || options2 === void 0 ? void 0 : options2.getOptions);
            _a2.label = 1;
          case 1:
            _a2.trys.push([1, 3, , 4]);
            return [4, get(reference)];
          case 2:
            result = _a2.sent();
            if (isMounted) {
              setValue(result);
...
react-firebase-hooks/firestore/dist/index.esm.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=react-firebase-hooks_firestore.js.map
